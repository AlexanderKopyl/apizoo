...
$_['progress_import_updating_combinations_as_products_index'] = '<b>Обновление комбинации как индекса продукта ... </b> Предупреждение: проявите терпение, это может занять время! %s';
