<?php
$_['profile_start_to_work'] = 'Для начала работы, создайте свой первый профиль во вкладке "<b>%sИмпорт - Экспорт%s</b>".';
$_['profile_create_or_edit_profile_main_tile'] = 'Создание или редактирование профилей';
$_['profile_legend_text'] = 'Изменить или создать новый профиль импорта/экспорта - Запустить профили на вкладке "<a href="javascript:{}" onclick="$(\'a.tab_export---import, a.tab_Экспорт---Импорт\').click()">Импорт - Экспорт</a>"';
$_['profile_select_text'] = 'Редактировать профиль';
$_['profile_delete_configuration'] = 'Удалить выбранный профиль';
...
$_['profile_create_import_text'] = 'Импорт';
$_['profile_create_export_text'] = 'Экспорт';
$_['profile_i_want_products'] = 'Товары';
$_['profile_i_want_specials'] = 'Акции';
$_['profile_i_want_discounts'] = 'Скидки';
$_['profile_i_want_images'] = 'Изображения';
$_['profile_i_want_product_option_values'] = 'Товары - значения опций';
...
$_['profile_i_want_order_products'] = 'Товары в заказе';
$_['profile_i_want_order_totals'] = 'Итоги заказа';
...
$_['profile_import_products_category_tree_last_child_modal_description'] = '    <p>Результат работы если параметр <b>ВЫКЛЮЧЕН</b>:</p><img style="width: 360px;" src="%s">
    <br><br>
    <p>В итоговом файле будут представлены в том числе и промежуточные категории, к которым может относиться товар</p>
    <br><br>
    <p>Результат работы если параметр <b>ВКЛЮЧЕН</b>:</p><img style="width: 360px;" src="%s">
    <br><br>
...
$_['profile_import_products_sum_tax_remodal_description'] = '    <p><b>Импорт:</b> Если у товара есть налоговый класс, то это значение будет добавлено к цене товара ВО ВРЕМЯ ЕГО СОЗДАНИЯ. Это может быть полезно, если в полученных от поставщика прайсах цены на товары указаны <b>без  налогов</b>, а Вы хотите импортировать цены <b>с налогами</b>.</p>
    <p><b>Экспорт:</b> Если у товара есть налоговый класс, то это значение будет <b>добавлено к цене</b>. Это может быть полезно в том случае, если в результате экспорта Вам необходимы цены с учетом налоговых ставок.</p>
';
...
$_['profile_export_sort_language'] = 'Язык';
...
$_['profile_import_products_skip_existing_images'] = 'Пропустить существующие изображения';
$_['profile_import_products_skip_existing_images_help'] = '<b>Только для изображений загруженных удаленно </b><br>Если изображение уже существует на вашем сервере, система импорта не загрузит его.';
...
$_['profile_import_column_config_thead_column'] = 'Поле';
$_['profile_import_column_config_thead_column_custom_name'] = 'Название колонки в файле';
$_['profile_import_column_config_thead_column_default_value'] = 'Значение по умолчанию';
$_['profile_import_categories_mapping'] = 'Разметка категорий';
...
$_['profile_column_config_extra_configuration_id_instead_of_name'] = 'ID вместо Названия:';
$_['profile_column_config_extra_configuration_round'] = 'Вокруг:';
$_['profile_column_config_extra_configuration_strip_html_tags'] = 'Убрать HTML-теги';
$_['profile_column_config_extra_configuration_strip_html_tags_help'] = 'Введите через запятую HTML-теги, которые Вы хотите отсортировать. <br>Пример: <b>br,ul,li</b><br>. Напишите <b>\'all\'</b> если Вы хотите убрать все теги.';
$_['profile_column_config_extra_configuration_max_length'] = 'Mаксимальная длина:';
$_['profile_column_config_extra_configuration_max_length_help'] = 'Сократите количество символов в поле до разрешенной максимальной длины';
$_['profile_column_config_extra_configuration_delete_associated_images'] = 'Удалить связанные изображения:';
...
$_['profile_column_config_extra_configuration_profit_margin'] = 'Размер прибыли (%)';
$_['profile_column_config_extra_configuration_profit_margin_help'] = 'модуль увеличит цену товара в %, согласно значению данного поля. <b><u>ТОЛЬКО ЦИФРЫ</u></b>';
...
$_['profile_products_import_filters'] = 'Настройка предварительного фильтра';
$_['profile_import_filter_config'] = 'Фильтры';
$_['profile_products_filters_add_filter'] = 'Нажмите чтобы добавить фильтр';
$_['profile_products_filters_open_group'] = 'Нажмите, чтобы открыть группу фильтров';
$_['profile_products_filters_close_group'] = 'Нажмите, чтобы закрыть группу фильтров';
...
$_['profile_products_filters_thead_apply_to'] = 'Применить для:';
...
$_['profile_products_filters_main_conditional'] = 'Условие по умолчанию для нового фильтра';
...
$_['profile_products_filters_actions_delete'] = 'Удалить';
$_['profile_products_filters_actions_skip'] = 'Пропустить';
$_['profile_products_filters_actions_disable'] = 'Отключить';
$_['profile_products_filters_applyto_shop'] = 'Магазин';
$_['profile_products_filters_applyto_file'] = 'Файл';
...
$_['profile_column_config_extra_configuration_splitted_values'] = 'Значения разделены';
$_['profile_column_config_extra_splitted_values_title'] = 'Колонка разделенных значений';
$_['profile_column_config_extra_splitted_values_description'] = '<p>Если Вы хотите <b>импортировать</b> файл, содержащий несколько значений в одном столбце, которые <b>разделены символом</b>, необходимо использовать следующую конструкцию:</p>
   <ol>
    <li><b>Произвольное имя колонки:</b> "COLUMN_NAME>POSITION" (0=1, 1=2, 2=3...)</li>
    <li><b>Расширенные настройки -> "Символ - Разделитель":</b> Введите символ, который будет разделять несколько значений.</li>
    </ol>
<img style="width: 605px;" src="%s">
<br><br>
<p>Пример:</p>
<ul>
<li><b>Категории>0</b> = Для мужчин</li>
<li><b>Категории>1</b> = Аксессуары</li>
<li><b>Категории>2</b> = Обувь</li>
</ul>
';
...
$_['profile_error_xml_custom_columns'] = 'Ошибка при сохранении профиля: Колонка "<b>%s</b>" содержит ошибки в названии, пробелы или недопустимые символы ("<b>*</b>" и "<b>@</b>" только эти символы допускаются в настройках профиля <b>импорта</b>).';
$_['profile_error_splitted_values'] = 'Ошибка при сохранении профиля: Колонка "<b>%s</b>" не содержит символ "<b>></b>", хотя отмечена как колонка с"<b>Разделенными значениями</b>". Пример: "<b>%s>0</b>"';
$_['profile_import_mapping_xml_columns_remodal_title'] = 'ПРИМЕРЫ СОПОСТАВЛЕНИЯ КОЛОНОК XML';
$_['profile_import_mapping_xml_columns_remodal_description'] = '    <p>Здесь указаны все возможные варианты "<b>названий произвольных колонок</b>" в формате <b>XML</b> для процесса <b>импорта</b></p><br>
    <img style="width: 605px;" src="%s">
    <p>"<b>CODE</b>" = 23434</p>
    <img style="width: 605px;" src="%s">
    <p>"<b>CATEGORIES>CATEGORY*0</b>" = Для женщин<br>
    "<b>CATEGORIES>CATEGORY*1</b>" = Аксессуары<br>
    "<b>CATEGORIES>CATEGORY*2</b>" = Ожерелья</p>
    <img style="width: 605px;" src="%s">
    ...
    <img style="width: 605px;" src="%s">
    <p>Для всех этих случаев необходимо применять правила для "<b>Разделенных значений</b>" rules.</p>
';
$_['profile_import_mapping_xml_columns_link_title'] = 'ВАЖНО: ПРОЧТИТЕ ОБ ОСОБЕННОСТЯХ ФАЙЛА XML В ПРОЦЕССЕ ИМПОРТА';
$_['profile_import_force_utf8'] = 'Используйте кодировку UTF8';
$_['profile_import_force_utf8_none'] = 'Без кодировки';
$_['profile_import_force_utf8_from_windows_1251'] = 'Кодировка windows-1251 (подходит для русского)';
$_['profile_import_force_utf8_from_windows_1252'] = 'Кодировка windows-1252 (для остальных языков)';
$_['profile_import_products_force_utf8_remodal_title'] = 'Используйте кодировку UTF8';
$_['profile_import_products_force_utf8_remodal_description'] = 'Если Вы заметили какие-то ошибкипосле импорта <b>файла от поставщика</b> (пустые поля, неизвестные значения и т.д.) включите эту опцию, очень возможно, что импортируемый файл записан в кодировке <b>ANSI</b> и его необходимо перевести в кодировку<b>UTF8</b>.<br><br><b style="color: #ff0000;">Если профиль импорта отработал корректно, ни в коем случае НЕ ВКЛЮЧАЙТЕ эту опцию, или Вы получите ошибки.</b>';
$_['profile_import_products_force_utf8_link_title'] = '<b>ВАЖНО</b>: Нажмите, чтобы прочесть!';
$_['profile_import_file_without_columns'] = 'Файл без колонок';
$_['profile_import_file_without_columns_remodal_title'] = 'Файл без колонок';
$_['profile_import_file_without_columns_remodal_description'] = '<p>Эта опция позволит вам импортировать / экспортировать файл CSV без заголовков.</p><p>При импорте вы должны включить порядок столбцов (1,2,3,4...) в "Название колонки в файле" поля "Отображение столбцов".</p>';
$_['profile_import_file_without_columns_link_title'] = '<b>ВАЖНО</b>: Нажмите, чтобы прочесть!';
$_['profile_export_remove_bom'] = 'Удалить BOM';
$_['profile_import_ftp_passive_mode'] = 'Пассивный режим';
$_['profile_import_ftp_passive_mode_help'] = 'Если появляется ошибка вида: <b>ftp_get(): Opening data channel for file download from server...</b> - включите данный режим.';
$_['profile_import_column_config_thead_column_conditional_value'] = 'Условное значение';
$_['columns_conditional_value_title'] = 'Условное значение';
$_['columns_conditional_value_description'] = '    <p>Мы можем определить условное значение для колонки на основе данных в этой или другой колонке.</p>
    <p><b>Условные символы:</b></p>
    <ul>
        <li><b style="color:#f00;">></b> Больше</li>
        <li><b style="color:#f00;"><</b> Меньше</li>
        <li><b style="color:#f00;">>=</b> Больше или равно</li>
        <li><b style="color:#f00;"><=</b> Меньше или равно</li>
        <li><b style="color:#f00;">!=</b> не равно</li>
        <li><b style="color:#f00;">==</b> Равно</li>
        <li><b style="color:#f00;">*</b> Содержит</li>
        <li><b style="color:#f00;">!*</b> Не содержит</li>
    </ul>
    <p><b>Прочий синтаксис символов:</b></p>
    <ul>
        <li><b style="color:#f00;">=</b> Результат</li>
        <li><b style="color:#f00;">(</b> Начало</li>
        <li><b style="color:#f00;">)</b> Конец</li>
        <li><b style="color:#f00;">:</b> Иначе</li>
        <li><b style="color:#f00;">[COLUMN_NAME]</b> Получить значение из колонки</li>
    </ul>
    <p><b>Примеры условных значений:</b></p>
    <ul>
        <li><b style="color:#f00;">(!=10=[Количество])</b>: Если значение в данной колонки не равно 10, то будет подставлено значение колонки "Количество".</li>
        <li><b style="color:#f00;">(===[Название])</b>: Если в данной колонке нет значений, то будет подставлено значение из колонки "Название".</li>
        <li><b style="color:#f00;">(>100=В наличии)</b>: Если значение колонки больше 100, ей будет присвоен статус "В наличии".</li>
        <li><b style="color:#f00;">(>=100=)</b>: Если значение в данной колонке больше или равно 100, то оно будет удалено.</li>
        <li><b style="color:#f00;">(*Audi-X1=Audi)(*Peugeot-20=Peugeot:BMW)</b>: Если в колонке содержится значение "Audi-X1", оно преобразуется в "Audi" так же, если в колонке содержится значение "Peugeot-20", то оно будет преобразовано в "Peugeot", иначе значение в колонке будет "BMW".</li>
        <li><b style="color:#f00;">(Количество>=1=true:false)</b>: Если мы поместим данное условное значение в колонку "Статус", то оно будет содержать в себе "истину", если в колонке "Количество" значение будет больше или равно 1  и "ложь" если значение в колонке "Количество" будет меньше или равно 0.</li>
        <li><b style="color:#f00;">(Cat. 1*cars=Tesla)</b>:При размещении данного условного значения в колонке "Производитель" значение в ней будет "Tesla", но при условии, что в колонке "Cat. 1" содержится слово "cars".</li>
    </ul>
    ';
$_['columns_conditional_value_link'] = '  <i style="font-size: 14px;" class="fa fa-info-circle"></i>';
$_['profile_save_legend'] = 'Сохранить профиль';
...
$_['profile_products_columns_fixed'] = 'Произвольные колонки';
$_['profile_products_columns_fixed_add'] = 'Добавить произвольную колонку';
$_['profile_products_columns_fixed_remove'] = 'Удалить произвольную колонку';
$_['profile_products_columns_fixed_add_explain'] = 'Нажмите, чтобы добавить новую произвольную колонку';
$_['profile_products_columns_fixed_column_name'] = 'Название колонки';
$_['profile_products_columns_fixed_column_value'] = 'Значение в колонке';
$_['profile_products_columns_fixed_column_actions'] = 'Действия';
$_['profile_import_products_sort_attributes'] = 'Сортировать атрибуты';
$_['columns_fixed_column_value_title'] = 'Значение колонки';
$_['columns_fixed_column_value_description'] = '<p>В этом поле можно использовать следующие значения:</p>
        <ol>
            <li><b>Названия</b>: Любые слова или числа, например, Ноутбук, Ноутбук 22 или 22 и т.д.</li>
            <li><b>Значение колонки</b>: имя пользовательской колонки в скобках, например: [Price] вернет значение колонки "Price"</li>
            <li><b>Значение колонки с вычислением</b>:
Вы можете ввести имя пользовательской колонки в скобках, за которым следует числовой оператор и значение, например: <b>[Price] * 10</b> будет переводить цену умножить на 10. Допустимые операторы:
                <ul>
                    <li><b>*</b> умножение</li>
                    <li><b>/</b> деление</li>
                    <li><b>+</b> сложение</li>
                    <li><b>-</b> вычитание</li>
                    <li><b>%</b> процент (остаток от деления)</li>
                </ul>
            </li>
        </ol>
';
$_['columns_fixed_column_value_link'] = '  <i style="font-size: 14px;" class="fa fa-info-circle"></i>';
$_['profile_products_columns_fixed_column_sort_order'] = 'Порядок сортировки';
$_['columns_fixed_column_sort_order_title'] = 'Порядок сортировки';
$_['columns_fixed_column_sort_order_description'] = 'С помощью этого поля вы можете установить порядок колонок с повторяющимися значениями в файле экспорта. Это можно сделать с помощью числового поля, где 0 - первая позиция. Помните, что если вы устанавливаете порядок для нескольких колонок с одинаковыми значениями, номер позиции каждого последующего столбца следует увеличить.

Если у вас есть 2 столбца с повторяющимися значениями: <b>«Значение налога»</b> и <b>«Наименование поставщика»</b>, которые вы хотите поместить в колонки <b>2 и 6</b>, то при настройке номеров позиций колонок с фиксированными значениями следует указывать <b>2 и 7</b>. Это необходимо, потому что после вставки первой колонки, все остальные <b>сместятся</b> на 1.';
$_['columns_fixed_column_sort_order_link'] = '  <i style="font-size: 14px;" class="fa fa-info-circle"></i>';
$_['profile_import_keep_store_assigns'] = 'Хранить назначения магазина';
$_['profile_import_keep_store_assigns_remodal_title'] = 'Хранить назначения магазина';
$_['profile_import_keep_store_assigns_remodal_description'] = '<p>Если эта опция активна, категории и производители, созданные в процессе импорта, будут назначены магазинам, которые обрабатывают товар, в противном случае они будут назначены всем магазинам.</p>';
$_['profile_import_keep_store_assigns_link'] = '<b>ВАЖНО</b>: Нажмите, чтобы прочесть!';
$_['profile_import_products_options_grouped_by'] = 'Опции сгруппированы по';
$_['profile_import_products_options_grouped_by_help'] = 'Вы должны ввести здесь имя колонки, по которой Вы хотите сгруппировать параметры товаров';
$_['profile_switch_allow_ids_label'] = 'ID вместо имени:';
$_['profile_import_xml_subproducts_inside_products_switch_button_label'] = 'Сопутствующие товары внутри тегов товара';
$_['profile_import_xml_subproducts_inside_products_subproduct_xml_node_label'] = 'Сопутствующие товары XML node';
$_['profile_export_filters_error_empty_filter'] = '<strong>Пустой фильтр</strong>: [%s]';
$_['profile_export_filters_error_numeric_filter_expected'] = '<strong>Числовой фильтр</strong>: [%s], но значение не является числом: \"%s\" ';
$_['profile_export_filters_error_date_filter_expected'] = '<strong>Фильтр по дате</strong>: [%s], но значение не является корректной датой: \"%s\"';
$_['profile_export_filters_error_relative_date_filter_expected'] = '<strong>Взаимосвязанная дата в фильтре </strong>: [%s], но значение не является числом: \"%s\"';
$_['profile_delete_confirmation_title'] = 'Подтверждение удаления профиля';
$_['profile_delete_confirmation_description'] = 'Вы <strong>действительно</strong> хотите удалить этот профиль?';
$_['profile_data_error_please_reload'] = 'Пожалуйста, перезагрузите страницу с профилем.';
$_['profile_data_error_column_mappings'] = 'Не удалось загрузить разметку столбцов.';
$_['profile_data_error_filters'] = 'Не удалось загрузить фильтры.';
$_['profile_data_error_custom_fixed_columns'] = 'При загрузке пользовательских столбцов с фиксированными значениями возникли проблемы.';
$_['profile_data_error_categories_mapping'] = 'Не удалось загрузить разметку столбцов.';
$_['profile_data_error_sort_order'] = 'Не удалось загрузить сортировку.';
$_['profile_unexpected_data_error'] = 'Возникли проблемы с загрузкой некоторых данных на странице.';
$_['profile_import_categories_mapping_load_columns'] = 'Получить категории';
$_['profile_import_categories_categories_file_label'] = 'Файл категорий';
$_['profile_import_categories_default_label'] = 'Категория по умолчанию';
$_['profile_import_categories_user_category'] = 'Категория пользователя';
$_['profile_import_categories_opencart_category'] = 'Категория OpenCart';
$_['profile_import_categories_configure_columns_first_warning'] = 'Вы <strong>ДОЛЖНЫ</strong> <u>сначала</u> настроить разметку колонок. Если этого не сделать, Вы не найдете все активные категории.';
$_['profile_import_error_missing_upload_file_or_invalid_format'] = 'Загружаемый файл потерян или имеет не корректный формат';
$_['profile_import_error_missing_url'] = 'Загружаемый URL пуст';
$_['profile_import_error_missing_ftp_info'] = 'FTP соединение не установлено';
$_['profile_import_error_missing_ftp_invalid_port'] = 'Не правильный FTP порт';
$_['profile_import_error_categories_columns_not_configured'] = 'Колонки категорий не настроены в данных о товаре или в разметке колонок';
$_['profile_import_error_no_categories_found'] = 'Категории не были найдены';
$_['profile_import_error_invalid_xml_main_node'] = 'Главная XML node не корректна';
...
$_['profile_import_products_profile_sort_attributes_remodal_title'] = 'Сортировка атрибутов';
$_['profile_import_products_profile_sort_attributes_remodal_description'] = '<p><b>Сортировка атрибутов ОТКЛЮЧЕНА</b>: Оставьте отключенным, если вы не хотите сортировать атрибуты, просто используйте их естественный (определенный товаром) порядок.
    <br>
    Пример:</p>
    <img style="width: 605px;" src="%s">
    <br><br>

    <p><b>Сортировка атрибутов ВКЛЮЧЕНА</b>: Включите, если хотите отсортировать атрибуты. Атрибуты переупорядочены: первое значение то, которое встречается чаще всего, второе, которое встречается немного реже, третье - еще немного реже и т. д. Сравните приведенный ниже пример с не сортированными данными.
    <br>
    Пример:</p>
    <img style="width: 605px;" src="%s">
';
$_['profile_import_products_profile_sort_attributes_link_title'] = '<b>ВАЖНО</b>: Нажмите, чтобы прочесть!';
$_['profile_import_columns_mapping_file_label'] = 'Файл колонок';
$_['profile_import_columns_mapping_load_columns'] = 'Получить колонки';
?>