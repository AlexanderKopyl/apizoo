                        ...
                        if(!empty($name)) {
                            ...
                            foreach ($this->stores_import_format as $key => $store) {
                                ...
                                if(!empty($manufacturer_seo_exists)) {
                                    $sql = 'UPDATE ' . $this->escape_database_table_name('seo_url') . ' SET ' . $this->escape_database_field('keyword') . ' = ' . $this->escape_database_value($keyword)." WHERE seo_url_id = ".$manufacturer_seo_exists['seo_url_id'];
                                } else {
